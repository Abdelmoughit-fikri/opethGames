"use client";
import { MoonIcon, ShoppingBagIcon, SunIcon } from "@heroicons/react/16/solid";
...
const ToggleDarkMode = () => {
  ...
  return (
    <div className="flex items-center gap-[30px]">
      <Link href={"/Cart"} className="relative w-[3rem] h-[3rem] cursor-pointer">
        <ShoppingBagIcon className="text-yellow-300" />
      </Link>
      <div
